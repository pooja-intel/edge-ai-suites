...
providing workloads that mimic real-time neonatal patient monitoring in a simulated hospital
warmer bed scenario. It helps medical AI developers and systems engineers evaluate
