...
The Robotics System Profiler integrates with **Grafana** and **Prometheus** to provide
real-time and historical visualization of ROS2 metrics — topic frequencies,
processing delays, CPU/memory usage, and more.

## Prerequisites

Complete the [Robotics System Profiler Installation Guide](installation.md) before continuing.
