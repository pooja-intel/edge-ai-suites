...
def _run_multimodal_gpu_flow(context, device):
    ...
    tsa_device = "GPU" if device_upper == "GPU" else "CPU"
    ...
    # Step 2: Configure Time Series Analytics UDF for the appropriate TSA device
    ...
    logger.info("Verifying TSAM logs confirm sklearnex accelerated execution on the requested TSA device...")
