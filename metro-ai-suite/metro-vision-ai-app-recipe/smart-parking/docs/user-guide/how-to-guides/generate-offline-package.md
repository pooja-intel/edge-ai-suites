...
> [!NOTE]
> This will stop all the pipelines and the streams. **DO NOT** run this if you want to see smart parking detection.
...
1. Open a browser and navigate to `https://127.0.0.1/grafana` to access the Grafana dashboard.
   ...
   > [!NOTE]
   > If you experience issues while streaming videos on grafana dashboard on Firefox, it is recommended to use Google Chrome.
